...
openssl req -x509 -newkey rsa:2048 -nodes \
  -keyout src/hw3/certs/localhost-key.pem \
  -out src/hw3/certs/localhost-cert.pem \
  -days 365 \
  -config src/hw3/certs/openssl-san.cnf
```

### Запуск

```
node src/hw3/server.js
node src/hw3/https-server.js
```
